class Validador {
    ...
    validaSignUp = (usuario) => {
        ...
        if (this.isEmpty(usuario.sobrenome.trim())) errosSignUp.sobrenome = 'Sobrenome não pode ser nulo'
        if (this.isEmpty(usuario.senha.trim())) errosSignUp.senha = 'Senha não pode ser nulo'
